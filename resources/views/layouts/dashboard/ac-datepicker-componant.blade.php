				...
				<ul class="list-unstyled">
					...
					<li class="dropdown pc-h-item pc-cart-menu">
						...
						<div class="dropdown-menu dropdown-menu-end pc-h-dropdown drp-cart">
							...
							<div class="cart-item">
								<img src="{{ asset('../') }}/assets/images/product/prod-1.jpg" alt="Product-img" title="Product-img" class="rounded me-3 border">
								<div class="cart-desc">
							...
							<div class="cart-item">
								<img src="{{ asset('../') }}/assets/images/product/prod-2.jpg" alt="Product-img" title="Product-img" class="rounded me-3 border">
								<div class="cart-desc">
									<a href="#!" class="text-body">
							...
							<div class="cart-item">
								<img src="{{ asset('../') }}/assets/images/product/prod-3.jpg" alt="Product-img" title="Product-img" class="rounded me-3 border">
								<div class="cart-desc">
									<a href="#!" class="text-body">

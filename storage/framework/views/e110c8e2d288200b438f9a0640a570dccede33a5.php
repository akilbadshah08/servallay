<?php $__env->startSection('content'); ?>
    ...
    <div class="container product_section_container" style="padding: 30px;">
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-12">
                <a href="<?php echo e(url('admin-program-videos/create')); ?> " class="btn btn-danger">
                ...
                <table class="table table-hover">
                    ...
                    <?php $__currentLoopData = $cdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(url('admin-program-videos/'.$module->id)); ?>/edit" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
                                <a href="<?php echo e(url('admin-program-videos/'.$module->id)); ?>" class="btn btn-danger" data-method="delete"

...
<div class="super_container">
    ...
    margin-right: 55px;
" href="<?php echo e(url('/admin-users')); ?>">Fitness Logo</a>
                                                </li>
                                          ...
                                          <li class="account"><a href="<?php echo e(url('/admin-blogs')); ?>"><i
                                                                class="fa fa-btn fa-cubes"></i>Blogs</a>                        
        ...
        <!--                    <a href="<?php echo e(route('home')); ?>"><span><?php echo e(config('app.name')); ?></span></a>-->
        <!--                </div>-->
        <!--                <nav class="navbar">-->

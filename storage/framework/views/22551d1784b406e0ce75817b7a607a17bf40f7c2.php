    ...
    <div class="container" style="padding: 100px 0;">
        ...
        <img src="<?php echo e(asset('assets/img/sign_up.jpg')); ?> ">
            ...
            <div class="col-md-6">
                <div class="card-1">
                  <form>
                          <?php  echo isset($user[0]->plan) && $user[0]->plan!=''?"<div class='alert alert-info'>Current Plan: ".$user[0]->plan."</div>":""; ?>
                          ...
                          <?php echo isset($charge->status) && $charge->status=='succeeded'?"<div class='alert alert-success'>Plan Activated Successfully</div>":""; ?>
                            ...
                            <div class="group row">
                              <label class='col-sm-12'>
                                ...
                                <input type="radio" checked="" value="4200"  name="plan" class="plan" /> Annual($42.00)
                                <input type="radio"  value="2100" name="plan" class="plan" /> Quarterly($21.00)
                              </label>

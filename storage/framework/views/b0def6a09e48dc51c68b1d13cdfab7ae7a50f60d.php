<?php $__env->startSection('content'); ?>
    ...
    <div class="container product_section_container" style="padding: 30px;">
        <div class="row" style="margin-bottom: 30px;">
            <div class="col-md-12">
                <a href="<?php echo e(url('admin-trainers/create')); ?> " class="btn btn-danger">
                ...
                <table class="table table-hover">
                    ...
                    <?php $__currentLoopData = $cdata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td><?php echo e($module->trainer_name); ?></td>
                            <td><?php echo str_limit(strip_tags($module->trainer_details), 30); ?></td>
                            <td><?php echo e($module->created_at); ?></td>
                            <td>
                                <a href="<?php echo e(url('admin-trainers/'.$module->id)); ?>/edit" class="btn btn-primary"><i class="fa fa-edit"></i> Edit</a>
                                <a href="<?php echo e(url('admin-trainers/'.$module->id)); ?>" class="btn btn-danger" data-method="delete"

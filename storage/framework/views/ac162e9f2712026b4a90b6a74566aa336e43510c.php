   ...
   <section class="programs">
      <div class="Coontact_us">
         ...
         <div class="Contact-header">
            <h2 class="mb-4">VIDEO CLASSES HISTORY</h2>
         </div>
                  ...
                  <div class="col-12">
                     <div class="video-thumbnail video_lib_video">
                        ...
                        <video  controls>
                          ...
                          <?php else: ?>
                          <img  src="<?php echo asset('uploads/'.$library->img); ?>" >
                           <a href="javascript:void(0)" id="pay" data-lib="<?php echo e($library->id); ?>" data-amount="<?php echo e($library->amount); ?>" class="video_rent">Pay Rent $<?php echo e(number_format((float)$library->amount,2)); ?></a>

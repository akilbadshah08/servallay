		...
		<div class="navbar-wrapper">
			...
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-providers')); ?>">    <i data-feather="settings"> </i>Providers</a>
					</li>
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-users')); ?>">    <i data-feather="settings"></i> Users</a>
					</li>

...
<body class="">
	...
	<div class="pc-mob-header pc-header">
		<div class="pcm-logo">
			<img src="<?php echo e(asset('../')); ?>/assets/images/logo.svg" alt="" class="logo logo-lg">
		</div>
		...
		<div class="navbar-wrapper">
			<div class="m-header">
				<a href="<?php echo e(url('admin-dashboard')); ?>" class="b-brand">
					...
					<img src="<?php echo e(asset('../')); ?>/assets/images/logo-sm.svg" alt="" class="logo logo-sm">
				</a>
			</div>
			<div class="navbar-content">
				<ul class="pc-navbar">
					...
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-dashboard')); ?>">    <i data-feather="settings"></i> Dashboard</a>
					</li>
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-category')); ?>">    <i data-feather="settings"> </i>Categories</a>
					</li>
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-users/index/1')); ?>">    <i data-feather="settings"> </i>Providers</a>
					</li>
					<li class="pc-item pc-hasmenu">
						<a class="pc-link" href="<?php echo e(url('admin-users/index/0')); ?>">    <i data-feather="settings"></i> Users</a>
					</li>
				...
				<div class="modal-body">
					...
					<div class="tab-content pt-4" id="pc-noti-tabContent">
						<div class="tab-pane fade show active" id="pc-noti-home" role="tabpanel" aria-labelledby="pc-noti-home-tab">
							<div class="media">
								<img src="<?php echo e(asset('../')); ?>/assets/images/user/avatar-1.jpg" alt="images" class="img-fluid avtar avtar-l">
							...
							<hr class="mb-4">
							<div class="media">
								<img src="<?php echo e(asset('../')); ?>/assets/images/user/avatar-2.jpg" alt="images" class="img-fluid avtar avtar-l">
								<div class="media-body ms-3 align-self-center">
									<div class="float-end">
										<div class="btn-group card-option">
											<button type="button" class="btn shadow-none px-0 dropdown-toggle arrow-none" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									...
									<p class="mb-0 d-inline-block  f-12 text-muted"> • 06/20/2019 at 6:43 PM </p>
									<p class="my-3">Cras sit amet nibh libero in gravida nulla Nulla vel metus scelerisque ante sollicitudin.</p>
									<img src="<?php echo e(asset('../')); ?>/assets/images/slider/img-slide-3.jpg" alt="images" class="img-fluid wid-90 rounded m-r-10 m-b-10">
									<img src="<?php echo e(asset('../')); ?>/assets/images/slider/img-slide-7.jpg" alt="images" class="img-fluid wid-90 rounded m-r-10 m-b-10">
								</div>
							</div>
							<hr class="mb-4">
							<div class="media mb-3">
								<img src="<?php echo e(asset('../')); ?>/assets/images/user/avatar-3.jpg" alt="images" class="img-fluid avtar avtar-l">
								<div class="media-body ms-3 align-self-center">
									<div class="float-end">
						...
						<div class="tab-pane fade" id="pc-noti-news" role="tabpanel" aria-labelledby="pc-noti-news-tab">
							<div class="pb-3 border-bottom mb-3 media">
								<a href="#!"><img src="<?php echo e(asset('../')); ?>/assets/images/news/img-news-2.jpg" class="wid-90 rounded" alt="..."></a>
							...
							<div class="pb-3 border-bottom mb-3 media">
								<a href="#!"><img src="<?php echo e(asset('../')); ?>/assets/images/news/img-news-1.jpg" class="wid-90 rounded" alt="..."></a>
								<div class="media-body ms-3">
...
<!-- [ Main Content ] end -->
    ...
    <!-- <script src="<?php echo e(asset('../')); ?>/https://cdnjs.cloudflare.com/ajax/libs/highlight.js/9.12.0/highlight.min.js"></script> -->

                                             ...
                                             <div class="video-testimonial-block ">
                                                <div height="56.25" class="video-thumbnail video_lib_video">
                                                  <img  src="<?php echo asset('uploads/'.$library->img); ?>">
                                                   <div class="css-144472i">Video <?php echo e($library->sub_title); ?></div>
               ...
               <div class="row mb-3">
                  <div class="col-12">
                     <div class="video-thumbnail video_lib_video">
                        <?php if((isset($userDetails->plan) && strtotime($userDetails->plan_date) == strtotime(date('Y-m-d')) && $library->sub_title==1) || (isset($fpay[$library->id]) && strtotime($fpay[$library->id]->created_at. ' + 3 day') > strtotime(date('Y-m-d')) )): ?>
                        <video  controls>
                          <source src="<?php echo e($library->library_url); ?>" type="video/mp4">
                          </video>
                          <?php else: ?>
                          <img  src="<?php echo asset('uploads/'.$library->img); ?>" >
                           <a href="javascript:void(0)" id="pay" data-lib="<?php echo e($library->id); ?>" data-amount="<?php echo e($library->amount); ?>" class="video_rent">Pay Rent <?php echo e($library->amount); ?></a>

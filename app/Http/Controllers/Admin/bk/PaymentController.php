...
class PaymentController extends Controller
{
    ...
    public function index()
    {
        ...
        $payments = Payment::select(['users.name', 'payment.*'])->join('users', 'users.id', '=', 'payment.user_id')->orderByDesc('id')->paginate(8);
        return view('admin.payment',compact('payments','categoryMenu'));
    }
